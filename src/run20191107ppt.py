...
if __name__ == '__main__':
    ...
    '''
    # working directory
    sourcepath_cut = 'F:/ferrofluid_experiment/postprocessing/20191107ppt';
    targetpath_cut = sourcepath_cut +'/cut';

    from cut import cutall
    cutall(x=[0.2,0.7],y=[0.2,0.4],sourcepath=sourcepath_cut,targetpath=targetpath_cut)
    ...
    for ite in enumerate(files):
        ...
        # get the raw contour
        cha1,contours,imorig,contoursorig = findOilBlob(filename,iterations=iteration,showresult=showresult);
